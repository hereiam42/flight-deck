  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        Icon: () => (
          <svg className="h-4 w-4" viewBox="0 0 16 16" fill="currentColor">
            <path d="M6 .5a.5.5 0 01.5-.5h3a.5.5 0 010 1H9v1.07a7.001 7.001 0 013.274 12.474.5.5 0 01-.548-.836A6 6 0 107 13.655v-1.577a.5.5 0 011 0v3a.5.5 0 01-.146.354l-1.5 1.5a.5.5 0 01-.708-.708L6.793 15H6.5A7.5 7.5 0 017 1.07V1H6.5a.5.5 0 01-.5-.5zM8 4a.5.5 0 01.5.5v3.793l1.854 1.853a.5.5 0 01-.708.708l-2-2A.5.5 0 017.5 8.5v-4A.5.5 0 018 4z" />
          </svg>
        ),
      },
    ],
